  ...
  Model.once('attached', () => {
    ...
    Model.prototype.executeDiffHooks = async function (phase, diff, ctx) {
      ...
      if (skipOpts !== true) {
        ...
        do {
          const data = cleanDataObject(this.toJSON()); // Keep to compare at the end
          ...
          // Recalculate diff to detect changes produced within the triggered hooks
          let finalData = cleanDataObject(this.toJSON());
